...
export default function ProgressDashboard() {
  ...
  // Count active/allowed calendars vs blocked ones
  const allowedCount = state.targetCalendars.filter(c => c.selected).length;
  const blockedCount = state.targetCalendars.filter(c => !c.selected).length;
  ...
  return (
    <div style={styles.container} className="glass-card animate-fade-in">
      ...
      <div style={styles.grid}>
        ...
        <div style={styles.metricCard}>
          <div style={styles.metricHeader}>
            <span style={styles.metricLabel}>Calendar Privacy Isolation</span>
            <span style={styles.metricIcon}>🛡️</span>
          </div>
          <div style={styles.metricValue}>
            {allowedCount} / {allowedCount + blockedCount}
          </div>
          <p style={styles.metricDesc}>
            {blockedCount} calendar(s) kept dark, dark, and fully inaccessible to the agent.
          </p>
        </div>
      </div>
